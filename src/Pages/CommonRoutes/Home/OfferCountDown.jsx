...
const OfferCountDown = () => {
  ...
  useEffect(() => {
    ...
    const startCountdown = () => {
      ...
      const endTime = storedEndTime ? parseInt(storedEndTime, 10) : Date.now() + 10 * 24 * 60 * 60 * 1000;
      ...
      timer = setInterval(() => {
        ...
        if (timeRemaining <= 0) {
          ...
          setCountdown({ days: daysRemaining, hours: hoursRemaining, minutes: minutesRemaining, seconds: secondsRemaining });
        }
      }, 1000);
    };
