...
const AddProduct = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (res.data.success) {
      ...
      axiosSecure.post("/addProduct", productInfo).then((res) => {
        if (res.data?.insertedId) {
          axiosSecure.patch(`/changeLimit/${productInfo?.shopId}`).then(() => {
            axiosSecure.patch(`/productCountIncrease/${productInfo?.shopId}`).then(() => {
              reset();
              ...
              <div className="flex flex-col md:flex-col lg:flex-row gap-6">
                ...
                <div className="form-control">
                  ...
                  <input
                    ...
                    className="file-input file-input-ghost w-full md:w-[390px] lg:w-[390px] mt-2"
                  />
                </div>
              </div>
